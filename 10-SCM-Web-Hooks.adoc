...
CAUTION: If you don't have a github account, create one, otherwise skip this step.
Go to https://github.com and press *Sign up* in the right corner and follow the sign up steps.

*Step 1: Create new application*

* We will use the forked repository from the previous lab.

Go first to https://github.com/hcs-company/bluegreen and fork this repro, by pressing the *Fork* button in the right corner and sign in, if you not already sign in GitHub.
