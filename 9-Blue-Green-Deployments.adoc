...
https://github.com/hcs-company/bluegreen
...
....
$ oc new-app --image-stream=php --code=https://github.com/hcs-company/bluegreen --env COLOR=blue --name=blue
....
...
....
$ oc expose service blue --hostname=bluegreen.hco-UserName.playground.hotcontainers.nl --name=bluegreen
....
...
....
$ oc new-app --image-stream=php --code=https://github.com/hcs-company/bluegreen --env COLOR=green --name=green
....
...
blue      ClusterIP   172.30.23.33    <none>        8080/TCP,8443/TCP   12m
green     ClusterIP   172.30.88.145   <none>        8080/TCP,8443/TCP   2m
....
...
* In Openshift 4, a bluegreen deployment is easier with the use of Istio.
