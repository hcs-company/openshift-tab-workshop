...
image::Xservice_catalog2.png[image]
...
image::Xmysql_ephemeral_template.png[image]
...
image::Xmysql_ephemeral_creation.png[image]

Click the *Next* button.

Click the checkbox to create the secret

image::Xmysql_secret_binding.png[image]
...
image::Xmysql_pod_on_proj_overview.png[image]
...
....
 ...
 deploymentconfig.apps.openshift.io/mysql labeled
....
...
https://github.com/hcs-company/php-pricelist

Browse through the code in this repository. If you take a look at the
link:https://raw.githubusercontent.com/hcs-company/php-pricelist/master/config/database.php[database configuration] file (`config/database.php`) you will see that
...
****
Add to Project: hco-UserName (this should be the same project as MySQL Ephemeral)
Application Name: pricelist
Git Repository: https://github.com/hcs-company/php-pricelist

image::Xphp.png[image]
...
image::Xdbtest_deployment_env.png[image]
...
image::Xcakephp_confirm.png[image]
...
image::Xconsole_project_overview.png[image]

You can check the build logs using the following command:

....
$ oc logs build/pricelist-1
Cloning "https://github.com/hcs-company/php-pricelist" ...
	Commit:	8feb14ade2ae18da000f93faedd5da1818f39814 (Update README.md)
	Author:	Christian Hernandez <christianh814@users.noreply.github.com>
	Date:	Wed Apr 10 15:52:07 2019 -0700
---> Installing application source...
=> sourcing 20-copy-config.sh ...
---> 21:12:09     Processing additional arbitrary httpd configuration provided by s2i ...
=> sourcing 00-documentroot.conf ...
=> sourcing 50-mpm-tuning.conf ...
=> sourcing 40-ssl-certs.sh ...

Pushing image docker-registry.default.svc:5000/hco-mkerker/pricelist:latest ...
...
....
$ oc project
Using project "hco-Username" on server "{{CONSOLE_ADDRESS}}".
...
image::Xapplication_create_screen.png[image]
